(function(){
   ...
   // Boton para mostrar el modal de agregar tarea
    ...
    modal.addEventListener('click', function(e){
        ...
        if(e.target.classList.contains('cerrar-modal')){ //delegation
            const formulario = document.querySelector('.formulario');
        ...
        if(e.target.classList.contains('submit-nueva-tarea')){
            const nombreTarea = document.querySelector('#tarea').value.trim(); //trim elimina los espacios que el usuario escriba 
   ...
   // Consultar el Servidor para añadir una nueva tarea al proyecto actual
    ...
    function obtenerProyecto(){
        ...
        const proyecto = Object.fromEntries(proyectoParams.entries()); //Leer la url del proyecto
        return proyecto.id;
    }
